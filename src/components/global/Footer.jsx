    ...
    <div className='main-hero-bg flex flex-col p-3  gap-3 text-white px-8 py-11'>
      <div className='flex justify-between'>
        <div className='flex flex-col gap-10 w-1/2'>
          <div className='flex gap-2 items-center'>
            ...
            <p className='font-medium'><span className='text-blue-800'>Vote</span>Secure</p>
          </div>
          <div className='lg:text-base text-sm'>
            <p className='font-medium'>About us</p>
            <p className='text-opacity-40 text-white'>Learn more about how our blockchain technology is transforming <br /> elections by ensuring secure, transparent, and trustworthy voting <br /> systems.</p>
          </div>
        </div>
      ...
      <div className='flex gap-12'>
        <div className='flex flex-col lg:text-base text-sm'>
          ...
          <p className='text-opacity-40 text-white'>Have questions or need assistance? <br /> Email: support@votesecure.com<br /><span>Phone: +1 (800) 123-4567</span></p>
        </div>
        <div className='w-1/2'>
          <p className='font-medium lg:text-base w-full text-sm lg:w-1/4'>Resources</p>
          <div className='flex-col flex gap-4 items-center md:flex-row lg:text-base text-sm'>
            <div className='flex flex-col w-full gap-3'>
              ...
              <div className='flex items-center  gap-2 text-opacity-40 text-white'>
                <img className='w-1/10 h-1/10' src={ellispe} alt="ellipse" />
                <p className='w-full'><a href="">Help Center</a></p>
              </div>
            </div>
            <div className='flex flex-col w-full gap-3'>
              <div className='flex items-center   gap-2 text-opacity-40 text-white'>
      ...
      <div className='w-full p-6 justify-items-center text-center items-center'>
        <p className='lg:text-xl text-opacity-40 text-white'>Copyright  © 2024 VoteSecure. All rights reserved.</p>
      </div>
    </div>
  );
};
